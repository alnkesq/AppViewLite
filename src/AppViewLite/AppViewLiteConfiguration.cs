...
namespace AppViewLite
{
    ...
    public enum AppViewLiteParameter
    {
        ...
        [Obsolete] APPVIEWLITE_FIREHOSE_PROCESSING_LAG_ERROR_THRESHOLD,
        APPVIEWLITE_USE_PROBABILISTIC_SETS,
        APPVIEWLITE_FIREHOSE_PROCESSING_LAG_WARN_INTERVAL_MS,
        [Obsolete] APPVIEWLITE_FIREHOSE_PROCESSING_LAG_ERROR_DROP_EVENTS,
        ...
        [Obsolete] APPVIEWLITE_DRAIN_FIREHOSE_BEFORE_CURSOR_CAPTURE,
        APPVIEWLITE_DIRECT_IO_BLOCK_CACHE_CAPACITY_MB,
        APPVIEWLITE_DIRECT_IO_MULTIBLOCK_CACHE_CAPACITY,
        APPVIEWLITE_LOW_DISK_SPACE_WARNING_MB,
        APPVIEWLITE_IGNORE_MISSING_SLICES,
        [Obsolete] APPVIEWLITE_DRAIN_FIREHOSE_VIA_SYNCHRONOUS_WAIT,
        APPVIEWLITE_LARGE_OBJECT_HEAP_COMPACTATION_INTERVAL_SECONDS,
        APPVIEWLITE_PROBABILISTIC_SET_DID_HASH_TO_USER_ID,
        APPVIEWLITE_PROBABILISTIC_SET_REL_FOLLOW,
        APPVIEWLITE_PROBABILISTIC_SET_REL_BLOCK,
        APPVIEWLITE_PROBABILISTIC_SET_DELETE_FOLLOW,
        APPVIEWLITE_PROBABILISTIC_SET_BLOCKLIST_SUBSCRIBER,
        APPVIEWLITE_PROBABILISTIC_SET_POST_LABEL,
        APPVIEWLITE_PROBABILISTIC_SET_POST_SYNTHETIC_ID,
        APPVIEWLITE_PROBABILISTIC_SET_LIST_ITEM,
        APPVIEWLITE_PROBABILISTIC_SET_WARNING_THRESHOLD,
        APPVIEWLITE_TABLE_WRITE_BUFFER_SIZE_SORTED,
        APPVIEWLITE_PROBABILISTIC_SET_LIST_ITEM_DELETION,
        APPVIEWLITE_PER_SLICE_SEEK_CACHE_SIZE,
        APPVIEWLITE_PROBABILISTIC_SET_REL_LIKES_RECENT,
        APPVIEWLITE_PROBABILISTIC_SET_REL_LIKES_RECENT_HOURS,
        APPVIEWLITE_NITTER_INSTANCE,
        APPVIEWLITE_SPAM_THROTTLER_LIKE,
        APPVIEWLITE_SPAM_THROTTLER_FOLLOW,
        APPVIEWLITE_SPAM_THROTTLER_POST,
        APPVIEWLITE_FIREHOSE_CONNECT_TIMEOUT_MS,
        APPVIEWLITE_TRACK_MANAGED_NATIVE_THREAD_ID_MAPPINGS,
    }
}
