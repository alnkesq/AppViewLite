...
namespace AppViewLite.Models
{
    ...
    public record struct Relationship(Plc Actor, Tid RelationshipRKey) : IComparable<Relationship>
    {
        ...
        public readonly int CompareTo(Relationship other)
        {
        ...
        public readonly string Serialize() => Actor.PlcValue + "_" + RelationshipRKey.TidValue;
        ...
        public override readonly string ToString() => $"{nameof(Relationship)}({Actor.PlcValue}, {RelationshipRKey})";
    }
}
