    ...
    public class RepositoryImportEntry
    {
        ...
        public string DisplayText
        {
            get
            {
                ...
                {
                    return $"Completed in {(double)DurationMillis / 1000:0.0} seconds ({InsertedRecordCount} records{(DownloadedBytes != 0 ? ", " + StringUtils.ToHumanBytes(DownloadedBytes) : null)}){suffix}";
                }
