...
namespace AppViewLite
{
    public class RelationshipProbabilisticCache<TTarget> : CombinedPersistentMultiDictionary<TTarget, Relationship>.CachedView where TTarget : unmanaged, IComparable<TTarget>
    {
        ...
        public override void MaterializeCacheFileThreadSafe(CombinedPersistentMultiDictionary<TTarget, Relationship>.SliceInfo slice, string destination)
        {
        ...
        {
            probabilisticSet.CheckProbabilisticSetHealthThreadSafe(context);
        }
    }
